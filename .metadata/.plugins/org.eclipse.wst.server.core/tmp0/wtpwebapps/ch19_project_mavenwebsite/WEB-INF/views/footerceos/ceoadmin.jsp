...
<style>
	...
	#section42 {padding-top:70px;height:700px;color: #fff; background-color: #DAA520;}
...
<body>
	 <div class="jumbotron">
	    ...
	    <br />
	 	...
	 	<br />
	 	<p id="katwo">CEO님 전용 관리 페이지 입니다.</p>
	 </div> 
	    ...
	    <div>
	      <div class="collapse navbar-collapse" id="myNavbar">
	        <ul class="nav navbar-nav">
	          ...
	          <li><a href="/footerceo">CEO Footer Page</a></li>
	          <li><a href="/footerceomenu">CEO Main Menu</a></li>
	        </ul>
	      </div>
	    </div>
	  </div>
	...
	<div id="section42" class="container-fluid">
	  <h1 style="color:black;font-size:xx-large;">CEO가 알려주는<b>Maven company Membership Code Service</b> 안내</h1>
	  ...
	  <p style="color:black;">
	  	<mark><b><a href="/footerceos/usermembership"><i class='fas fa-user-check' style='font-size:24px'></i>Maven Company</a></b></mark>기업에서는 사원증에 멤버십카드와 체크, 신용카드, 교통카드 
